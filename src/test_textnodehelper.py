...
class TestSplitNodesDelimiter(TestCase):
    def test_split_nodes_delimiter(self):
        ...
        self.assertEqual(textnodes_to_html(italic_splitted), '<i>Hi!</i> It\'s a *very* good, <i>valid</i> and *well-thought-out* Markdown! (a `code` language, used for `formatting`.) Let\'s <i>see</i>!')
    ...
    def test_split_nodes_image(self):
        ...
        self.assertEqual(textnodes_to_html(image_splitted), '*a* <img src="c" alt="b"></img> *c*')
