...
class TestTextHelper(TestCase):
    ...
    def test_extract_markdown_links(self):
        ...
        self.assertEqual(
            extracted[1]["md"], "[another](https://www.example.com/another)"
        )
    ...
    def test_both_extracts(self):
        ...
        self.assertEqual(
            extracted_images[0]["src"], "https://an-image.lava-magic.com/img1.png"
        )
        self.assertEqual(
            extracted_images[0]["md"],
            "![one image in it](https://an-image.lava-magic.com/img1.png)",
        )
        ...
        self.assertEqual(
            extracted_links[0]["href"], "https://a-doc.lava-magic.com/doc1.txt"
        )
        self.assertEqual(
            extracted_links[0]["md"],
            "[one link as well](https://a-doc.lava-magic.com/doc1.txt)",
        )
