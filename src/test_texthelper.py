...
class TestTextHelper(TestCase):
    def test_extract_markdown_images(self):
        ...
        self.assertEqual(extracted[0]['md'], '![image](https://storage.googleapis.com/qvault-webapp-dynamic-assets/course_assets/zjjcJKZ.png)')
        ...
        self.assertEqual(extracted[1]['md'], '![another](https://storage.googleapis.com/qvault-webapp-dynamic-assets/course_assets/dfsdkjfd.png)')
    ...
    def test_extract_markdown_links(self):
        ...
        self.assertEqual(extracted[0]['md'], '[link](https://www.example.com)')

        self.assertEqual(extracted[1]['a_text'], 'another')
        self.assertEqual(extracted[1]['href'], 'https://www.example.com/another')
        self.assertEqual(extracted[1]['md'], '[another](https://www.example.com/another)')
    ...
    def test_both_extracts(self):
        ...
        self.assertEqual(extracted_images[0]['md'], '![one image in it](https://an-image.lava-magic.com/img1.png)')
        ...
        self.assertEqual(extracted_links[0]['md'], '[one link as well](https://a-doc.lava-magic.com/doc1.txt)')
